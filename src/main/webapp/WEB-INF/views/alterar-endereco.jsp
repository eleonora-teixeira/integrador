    ...
    <div class="container" style="margin-top: 50px">
        <div class="row justify-content-center content-row">
            <div class="media-container-column title col-12 col-lg-7 col-md-6">
                ...
                <h2 class="align-left mbr-bold mbr-fonts-style display-5" style="margin-left: 194px">ESCOLHA O ENDEREÇO</h2>
            </div>

            <div class="media-container-column col-12 col-lg-3 col-md-4">
                <div class="mbr-section-btn align-right py-4">
                    <form action="cadastroEndereco" method="post">
                        <button type="submit" name="acao" value="vaiNovoEnd2" class="btn btn-primary display-4">&nbsp;NOVO ENDEREÇO</button>
                    </form>
                </div>
            </div>
        </div>
                ...
                <div class="row timeline-element">
                    <div class="col-xs-12 col-md-6 align-left">
                        <div class="timeline-text-content">
                            ...
                            <p class="mbr-timeline-text mbr-fonts-style display-7">${enderecos.getCidade()}/Estado</p>
                            <div class="row">
                                <div class="col-md-12 text-right">
                                    <form action="cadastroEndereco" method="post">
                                        <input type="hidden" name="id_end" value="${enderecos.getId_end()}">
                                        <button style="color: black; background-color: transparent; border-color: transparent" type="submit" name="acao" value="usarEnd">USAR ENDEREÇO<i class="material-icons">
                                            <img style="margin-top: -5px;margin-left: 5px" src="assets/images/check_circle_outline-24px.svg"></i>
                                        </button>
                                    </form>
                                </div>                                
                            </div>
