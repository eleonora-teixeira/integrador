...
<form action="cadastroEndereco" method="POST" class="mbr-form form-with-styler" data-form-title="Mobirise Form">
                    ...
                    <!---Formbuilder Form--->
                        ...
                        <div class="dragArea row">
                            <div class="col-md-12  form-group" data-for="destinatario">
                                ...
                                <input type="text" name="destinatario" data-form-field="Name" required="required" class="form-control display-7" >
                            </div>
                        </div>
                        <div class="dragArea row">
                        ...
                        <div class="dragArea row container">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <input type="radio" name="status" value="principal">
                        ...
                        <div class="dragArea row">
                            <div class="col-md-12 input-group-btn align-center">
                                <button type="submit" name="acao" value="cadastrarEnd2" class="btn btn-primary btn-form display-4">CADASTRAR NOVO ENDEREÇO</button>
                            </div>
                        </div>
                </div>
            </div>
