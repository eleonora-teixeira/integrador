...
<jsp:useBean id="compras" class="br.csi.dao.Compra_DAO" />
<c:set var="compras" value="${compras.getCompras(usuario.id)}" />
    ...
    <div class="container align-center">
        ...
        <c:forEach var="compras" items="${compras}">
            <div class="container timelines-container" mbri-timelines="" style="margin-top: 50px">
                <div class="col-xs-12 col-md-6 align-left" style="margin-left: 290px;">
                    <div class="timeline-text-content">
                        <div class="row">
                            <div class="col-md-10">
                                <h4 class="mbr-timeline-title pb-3 mbr-fonts-style display-5">${compras.getStatus()}</h4>
                                </div>
                                <div class="col-md-2 text-right">
                                    <div class="row">
                                        <form action="compras" method="post">
                                            <input type="hidden" name="id_compra" value="${compras.getId_compra()}">
                                            <input type="hidden" name="status" value="${compras.getStatus()}">
                                            <button type="submit" name="acao" value="delPedido" class="material-icons" style="background-color: transparent; border-color: transparent">
                                                <img src="assets/images/delete-24px.svg" style="margin-left: 50px"></button>
                                        </form>
                                    </div>                                
                            </div>
                        </div>
